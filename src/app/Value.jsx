export default function Value() {
    return (
        <div className="flex flex-col justify-evenly  w-full align-top pt-5 lg:flex-row lg:pr-30 lg:pl-30">
            ...
            <div className="flex flex-col items-center text-center p-5">
                <h2 className="text-3xl font-medium">Secure</h2>
                <p>Reliable, secure, and fast. Our hosting ensures your business stays online with minimal downtime and optimized performance for every visitor</p>
            </div>
            <div className="flex flex-col items-center text-center p-5">
