...
export default function AnimatedInfoCard({ title, content, children }) {
  ...
  return (
    <div className="mt-10 max-w-100 mx-auto">
      {/* Base card */}
      <div className="flex flex-col items-center justify-evenly min-h-40 p-6 text-center text-xl bg-white backdrop-blur-lg border border-gray-400 rounded-3xl shadow-md">
